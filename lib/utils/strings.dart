...
class Strings {
  static const String appName = "AI Creator";

  static const String chatWithAdBot = "Chat With $appName";
  static const String chatWithAdBotSubTitle =
      "Chatting with $appName can be a fun and interactive way to explore language and learn new things. ";
  ...
  static const String privacyPolicyUrl = "https://adbot.appdevs.net/privacy";
  static const String termsUrl = "https://adbot.appdevs.net/terms";
  static const String refundPolicyUrl = "https://adbot.appdevs.net/refund";
  ...
  static const String hashTagCreatorSubTitle =
      "Generate your hashTags with AdBot now for your Social Media·";
...
//from here to //end  copy the code and pest it exactly in your code in this order (version 3.7.0)
  ...
  static const String dietChartCreatorSubTitle = "Generate your diet chart with AdBot now for healthy life·";
